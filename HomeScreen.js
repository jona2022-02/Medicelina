  ...
  return (
    <ImageBackground source={fondo} style={styles.background}>
      <View style={styles.header}>
        <Title style={styles.title}>Panel de Administración - Medicelina</Title>
        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <Text style={{ marginTop: 6 }}>
              Medicelina es una farmacia comprometida con la salud de las familias. Brindamos atención especializada y distribución de medicamentos con responsabilidad.
            </Text>
